...
public class AutomateMove : MonoBehaviour
{
    ...
    public RuntimeAnimatorController controller;           //animator controller in Unity that stores all clips and transitions
    ...
    void Update()
    {
        ...
        {   
            ...
            if (animatorBody != null)                                     //check for a null animator (This means the robot has hit the fence)
            {    
                ...
                // do stuff if robot hits fence eventually maybe?
            }
        }
    }
